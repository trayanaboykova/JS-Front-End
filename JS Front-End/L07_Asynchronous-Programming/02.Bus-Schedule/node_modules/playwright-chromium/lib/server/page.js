...
const frames = __importStar(require("playwright-chromium/lib/server/frames"));
const input = __importStar(require("playwright-chromium/lib/server/input"));
const js = __importStar(require("playwright-chromium/lib/server/javascript"));
const network = __importStar(require("playwright-chromium/lib/server/network"));
const screenshotter_1 = require("playwright-chromium/lib/server/screenshotter");
const timeoutSettings_1 = require("playwright-chromium/lib/utils/timeoutSettings");
const types = __importStar(require("playwright-chromium/lib/server/types"));
...
const accessibility = __importStar(require("playwright-chromium/lib/server/accessibility"));
const fileChooser_1 = require("playwright-chromium/lib/server/fileChooser");
const progress_1 = require("playwright-chromium/lib/server/progress");
