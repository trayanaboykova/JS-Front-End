...
var Promise = require('workerpool/src/Promise');
var environment = require('workerpool/src/environment');
var requireFoolWebpack = require('workerpool/src/requireFoolWebpack');
...
function getDefaultWorker() {
  if (environment.platform === 'browser') {
    ...
    var blob = new Blob([require('workerpool/src/generated/embeddedWorker')], {type: 'text/javascript'});
