...
const androidDispatcher_1 = require("playwright-chromium/lib/dispatchers/androidDispatcher");
const browserTypeDispatcher_1 = require("playwright-chromium/lib/dispatchers/browserTypeDispatcher");
const dispatcher_1 = require("playwright-chromium/lib/dispatchers/dispatcher");
const electronDispatcher_1 = require("playwright-chromium/lib/dispatchers/electronDispatcher");
...
class PlaywrightDispatcher extends dispatcher_1.Dispatcher {
    constructor(scope, playwright) {
        const descriptors = require('playwright-chromium/lib/server/deviceDescriptors');
