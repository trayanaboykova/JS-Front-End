...
const showDir = require('ecstatic/lib/ecstatic/show-dir');
const version = require('ecstatic/package.json').version;
const status = require('ecstatic/lib/ecstatic/status-handlers');
const generateEtag = require('ecstatic/lib/ecstatic/etag');
const optsParser = require('ecstatic/lib/ecstatic/opts');
...
if (!module.parent) {
  ...
  const defaults = require('ecstatic/lib/ecstatic/defaults.json');
  const http = require('http');
  const minimist = require('minimist');
  const aliases = require('ecstatic/lib/ecstatic/aliases.json');
