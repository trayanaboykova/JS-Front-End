...
const driver_1 = require("playwright-chromium/lib/cli/driver");
const traceViewer_1 = require("playwright-chromium/lib/cli/traceViewer/traceViewer");
const playwright = __importStar(require("playwright-chromium"));
commander_1.default
    .version('Version ' + require('playwright-chromium/package.json').version)
    .name('npx playwright')
