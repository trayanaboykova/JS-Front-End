...
const codeGenerator_1 = require("playwright-chromium/lib/server/supplements/recorder/codeGenerator");
const utils_1 = require("playwright-chromium/lib/server/supplements/recorder/utils");
const page_1 = require("playwright-chromium/lib/server/page");
const frames_1 = require("playwright-chromium/lib/server/frames");
const browserContext_1 = require("playwright-chromium/lib/server/browserContext");
const java_1 = require("playwright-chromium/lib/server/supplements/recorder/java");
const javascript_1 = require("playwright-chromium/lib/server/supplements/recorder/javascript");
const csharp_1 = require("playwright-chromium/lib/server/supplements/recorder/csharp");
const python_1 = require("playwright-chromium/lib/server/supplements/recorder/python");
const recorderSource = __importStar(require("playwright-chromium/lib/generated/recorderSource"));
const consoleApiSource = __importStar(require("playwright-chromium/lib/generated/consoleApiSource"));
const recorderApp_1 = require("playwright-chromium/lib/server/supplements/recorder/recorderApp");
const instrumentation_1 = require("playwright-chromium/lib/server/instrumentation");
