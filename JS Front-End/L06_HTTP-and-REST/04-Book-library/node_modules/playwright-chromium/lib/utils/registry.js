...
const ubuntuVersion_1 = require("playwright-chromium/lib/utils/ubuntuVersion");
...
class Registry {
    ...
    browserDirectory(browserName) {
        ...
        return path_1.default.join(exports.registryDirectory, `${browser.name}-${browser.revision}`);
    }
