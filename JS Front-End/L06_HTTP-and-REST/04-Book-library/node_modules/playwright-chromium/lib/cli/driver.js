...
const playwright = __importStar(require("playwright-chromium"));
const dispatcher_1 = require("playwright-chromium/lib/dispatchers/dispatcher");
const playwrightDispatcher_1 = require("playwright-chromium/lib/dispatchers/playwrightDispatcher");
const installer_1 = require("playwright-chromium/lib/install/installer");
const transport_1 = require("playwright-chromium/lib/protocol/transport");
const playwright_1 = require("playwright-chromium/lib/server/playwright");
const processLauncher_1 = require("playwright-chromium/lib/server/processLauncher");
function printApiJson() {
    console.log(JSON.stringify(require('playwright-chromium/api.json')));
}
