...
const version = require('http-server/package.json').version;
const status = require('http-server/lib/core/status-handlers');
const generateEtag = require('http-server/lib/core/etag');
const optsParser = require('http-server/lib/core/opts');
